import{a4 as r,t as d,a5 as l,a6 as c,a7 as p,a8 as n,ac as h,a9 as s,ag as t,Q as u}from"./index.ff52863b.js";import{Q as m}from"./QPage.a2fd5198.js";import{E as g}from"./executiveSummary.0c63e73c.js";const f=d({name:"LivingPlanPage",data(){return{planSections:[g]}},computed:{currentRouteName(){return this.$route.name}},mounted(){console.log(this.$route.path),this.$route.path;for(var e=document.querySelectorAll(".q-markdown--link-local"),a=0,i=e.length;a<i;a++)e[a].href="javascript:void(0)",console.log(e[a].href)},methods:{onToc(e){this.toc=this.$refs.markdown.makeTree(e),console.log(this.toc)}}}),v={class:"q-ma-xl"};function T(e,a,i,w,y,S){const o=l("q-markdown");return c(),p(m,{class:"row"},{default:n(()=>[h("div",v,[s(o,{src:`
# Executive Summary
