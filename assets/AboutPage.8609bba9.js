import{Q as n}from"./QPage.77ceec9c.js";import{$ as r,A as o,a0 as i,a1 as d,a2 as l,a3 as c,aa as p,a4 as m}from"./index.ee6be7d0.js";var h=`# What is TDIS?\r
...
The complete strategic plan for TDIS can be found on the www.tdis.io webpages and cited as follows:\r
...
`;const f=o({name:"AboutPage",data(){return{markdown:h}},mounted(){console.log(this.$route.path),this.$route.path;for(var e=document.querySelectorAll(".q-markdown--link-local"),a=0,s=e.length;a<s;a++)e[a].href="javascript:void(0)",console.log(e[a].href)}}),u={class:"q-ma-xl"};function g(e,a,s,v,T,b){const t=i("q-markdown");return d(),l(n,{class:"row"},{default:c(()=>[p("div",u,[m(t,{src:e.markdown,disable:!0,class:"q-pa-md markdown-disabled"},null,8,["src"])])]),_:1})}var y=r(f,[["render",g],["__scopeId","data-v-2518c395"]]);export{y as default};
