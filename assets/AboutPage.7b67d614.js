import{Q as s}from"./QPage.3d512550.js";import{_ as t,A as n,N as r,O as o,R as i,S as d,a0 as l,U as c}from"./index.382f3a4f.js";var p=`\r
# What is TDIS?\r
...
\r
Hosted by the Institute for a Disaster Resilient Texas (IDRT), TDIS is funded by the Texas General Land Office and is implemented by IDRT at Texas A&M University in partnership with  the Texas Advanced Computing Center (TACC) at the University of Texas at Austin. This partnership leverages the knowledge and expertise at both universities and ensures that the data and tools will be open source, accessible, and usable. The stakeholders and users of TDIS are engineers, analysts, planners, and decision makers at local, state, and federal agencies. The success of TDIS rests on delivering services and tools that our local, state, and federal stakeholders want and use. \r
\r
...
The Texas Disaster Information System (TDIS) started in 2020 with a year-long planning and ideation process, led by the Institute for a Disaster Resilient Texas (IDRT) of Texas A&M and the Texas Advanced Computing Center at the University of Texas at Austin. TDIS is envisioned initially as a ten-year effort. Phase 1 of TDIS development kicked off in February 2022. `;const h=n({name:"AboutPage",data(){return{markdown:p}},methods:{onToc(e){this.toc=this.$refs.markdown.makeTree(e),console.log(this.toc)}}}),f={class:"q-ma-xl"};function m(e,u,g,T,v,b){const a=r("q-markdown");return o(),i(s,{class:"row"},{default:d(()=>[l("div",f,[c(a,{src:e.markdown,toc:"","toc-start":2,"toc-end":3,onData:e.onToc,ref:"markdown",class:"q-pa-md"},null,8,["src","onData"])])]),_:1})}var k=t(h,[["render",m]]);export{k as default};
