import{Q as l}from"./QPage.e41402bf.js";import{a4 as c,t as p,a5 as h,a6 as n,a7 as i,a8 as u,ac as s,aa as m,ah as g,ai as f}from"./index.e93b8341.js";var v=`# Executive Summary
...
`;const T=p({name:"LivingPlanPage",data(){return{planSections:[v]}},computed:{currentRouteName(){return this.$route.name}},mounted(){console.log(this.$route.path),this.$route.path;for(var e=document.querySelectorAll(".q-markdown--link-local"),a=0,t=e.length;a<t;a++)e[a].href="javascript:void(0)",console.log(e[a].href)},methods:{onToc(e){this.toc=this.$refs.markdown.makeTree(e),console.log(this.toc)}}}),w={class:"q-ma-xl"},y=s("a",{href:"/tdisplan_v1.0.pdf",download:""},"PDF link to plan",-1);function b(e,a,t,S,D,I){const o=h("q-markdown");return n(),i(l,{class:"row"},{default:u(()=>[s("div",w,[(n(!0),m(f,null,g(e.planSections,(r,d)=>(n(),i(o,{class:"q-ma-lg",key:d,src:r,ref_for:!0,ref:"markdownobject"},null,8,["src"]))),128)),y])]),_:1})}var z=c(T,[["render",b]]);export{z as default};
