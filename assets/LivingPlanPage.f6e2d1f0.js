import{Q as d}from"./QPage.78a69d70.js";import{_ as l,A as c,U as p,V as a,W as i,X as h,a3 as u,Z as g,ab as m,ac as f}from"./index.ff5cb82b.js";var v=`# Executive Summary
...
`,T=`# Vision and Planning Approach
...
`;const y=c({name:"LivingPlanPage",data(){return{planSections:[v,T]}},computed:{currentRouteName(){return this.$route.name}},mounted(){console.log(this.$route.path),this.$route.path;for(var e=document.querySelectorAll(".q-markdown--link-local"),n=0,t=e.length;n<t;n++)e[n].href="javascript:void(0)",console.log(e[n].href)},methods:{onToc(e){this.toc=this.$refs.markdown.makeTree(e),console.log(this.toc)}}}),w={class:"q-ma-xl"};function b(e,n,t,S,D,I){const s=p("q-markdown");return a(),i(d,{class:"row"},{default:h(()=>[u("div",w,[(a(!0),g(f,null,m(e.planSections,(o,r)=>(a(),i(s,{class:"q-ma-lg",key:r,src:o,ref_for:!0,ref:"markdownobject"},null,8,["src"]))),128))])]),_:1})}var z=l(y,[["render",b]]);export{z as default};
