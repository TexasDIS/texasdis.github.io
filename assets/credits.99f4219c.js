import{u as H,a as V,b as J}from"./QTabs.966c17f5.js";import{e as I,h as w,j as S,f as g,ag as L,g as B,a9 as N,d as T,a6 as Q,am as X,a as D,an as A,p as R,ar as x,ao as z,c as k,s as Y,r as M,w as E,a8 as $,n as K}from"./index.744998d2.js";import{u as Z,a as ee,b as te,c as ae,g as _,s as O}from"./use-panel.a8ed92e5.js";import{u as G,a as W}from"./use-dark.53cb4904.js";import{c as ne}from"./selection.3f2f58d7.js";var ue=I({name:"QTab",props:H,emits:V,setup(t,{slots:n,emit:s}){const{renderTab:d}=J(t,n,s);return()=>d("div")}}),he=I({name:"QTabPanel",props:Z,setup(t,{slots:n}){return()=>w("div",{class:"q-tab-panel",role:"tabpanel"},S(n.default))}}),pe=I({name:"QTabPanels",props:{...ee,...G},emits:te,setup(t,{slots:n}){const s=B(),d=W(t,s.proxy.$q),{updatePanelsList:e,getPanelContent:a,panelDirectives:i}=ae(),l=g(()=>"q-tab-panels q-panel-parent"+(d.value===!0?" q-tab-panels--dark q-dark":""));return()=>(e(n),L("div",{class:l.value},a(),"pan",t.swipeable,()=>i.value))}});function P(t,n,s){const d=z(t);let e,a=d.left-n.event.x,i=d.top-n.event.y,l=Math.abs(a),o=Math.abs(i);const r=n.direction;r.horizontal===!0&&r.vertical!==!0?e=a<0?"left":"right":r.horizontal!==!0&&r.vertical===!0?e=i<0?"up":"down":r.up===!0&&i<0?(e="up",l>o&&(r.left===!0&&a<0?e="left":r.right===!0&&a>0&&(e="right"))):r.down===!0&&i>0?(e="down",l>o&&(r.left===!0&&a<0?e="left":r.right===!0&&a>0&&(e="right"))):r.left===!0&&a<0?(e="left",l<o&&(r.up===!0&&i<0?e="up":r.down===!0&&i>0&&(e="down"))):r.right===!0&&a>0&&(e="right",l<o&&(r.up===!0&&i<0?e="up":r.down===!0&&i>0&&(e="down")));let u=!1;if(e===void 0&&s===!1){if(n.event.isFirst===!0||n.event.lastDir===void 0)return{};e=n.event.lastDir,u=!0,e==="left"||e==="right"?(d.left-=a,l=0,a=0):(d.top-=i,o=0,i=0)}return{synthetic:u,payload:{evt:t,touch:n.event.mouse!==!0,mouse:n.event.mouse===!0,position:d,direction:e,isFirst:n.event.isFirst,isFinal:s===!0,duration:Date.now()-n.event.time,distance:{x:l,y:o},offset:{x:a,y:i},delta:{x:d.left-n.event.lastX,y:d.top-n.event.lastY}}}}let ie=0;var se=N({name:"touch-pan",beforeMount(t,{value:n,modifiers:s}){if(s.mouse!==!0&&T.has.touch!==!0)return;function d(a,i){s.mouse===!0&&i===!0?Y(a):(s.stop===!0&&x(a),s.prevent===!0&&R(a))}const e={uid:"qvtp_"+ie++,handler:n,modifiers:s,direction:_(s),noop:Q,mouseStart(a){O(a,e)&&X(a)&&(D(e,"temp",[[document,"mousemove","move","notPassiveCapture"],[document,"mouseup","end","passiveCapture"]]),e.start(a,!0))},touchStart(a){if(O(a,e)){const i=a.target;D(e,"temp",[[i,"touchmove","move","notPassiveCapture"],[i,"touchcancel","end","passiveCapture"],[i,"touchend","end","passiveCapture"]]),e.start(a)}},start(a,i){if(T.is.firefox===!0&&A(t,!0),e.lastEvt=a,i===!0||s.stop===!0){if(e.direction.all!==!0&&(i!==!0||e.modifiers.mouseAllDir!==!0&&e.modifiers.mousealldir!==!0)){const r=a.type.indexOf("mouse")>-1?new MouseEvent(a.type,a):new TouchEvent(a.type,a);a.defaultPrevented===!0&&R(r),a.cancelBubble===!0&&x(r),Object.assign(r,{qKeyEvent:a.qKeyEvent,qClickOutside:a.qClickOutside,qAnchorHandled:a.qAnchorHandled,qClonedBy:a.qClonedBy===void 0?[e.uid]:a.qClonedBy.concat(e.uid)}),e.initialEvent={target:a.target,event:r}}x(a)}const{left:l,top:o}=z(a);e.event={x:l,y:o,time:Date.now(),mouse:i===!0,detected:!1,isFirst:!0,isFinal:!1,lastX:l,lastY:o}},move(a){if(e.event===void 0)return;const i=z(a),l=i.left-e.event.x,o=i.top-e.event.y;if(l===0&&o===0)return;e.lastEvt=a;const r=e.event.mouse===!0,u=()=>{d(a,r);let h;s.preserveCursor!==!0&&s.preservecursor!==!0&&(h=document.documentElement.style.cursor||"",document.documentElement.style.cursor="grabbing"),r===!0&&document.body.classList.add("no-pointer-events--children"),document.body.classList.add("non-selectable"),ne(),e.styleCleanup=f=>{if(e.styleCleanup=void 0,h!==void 0&&(document.documentElement.style.cursor=h),document.body.classList.remove("non-selectable"),r===!0){const b=()=>{document.body.classList.remove("no-pointer-events--children")};f!==void 0?setTimeout(()=>{b(),f()},50):b()}else f!==void 0&&f()}};if(e.event.detected===!0){e.event.isFirst!==!0&&d(a,e.event.mouse);const{payload:h,synthetic:f}=P(a,e,!1);h!==void 0&&(e.handler(h)===!1?e.end(a):(e.styleCleanup===void 0&&e.event.isFirst===!0&&u(),e.event.lastX=h.position.left,e.event.lastY=h.position.top,e.event.lastDir=f===!0?void 0:h.direction,e.event.isFirst=!1));return}if(e.direction.all===!0||r===!0&&(e.modifiers.mouseAllDir===!0||e.modifiers.mousealldir===!0)){u(),e.event.detected=!0,e.move(a);return}const p=Math.abs(l),m=Math.abs(o);p!==m&&(e.direction.horizontal===!0&&p>m||e.direction.vertical===!0&&p<m||e.direction.up===!0&&p<m&&o<0||e.direction.down===!0&&p<m&&o>0||e.direction.left===!0&&p>m&&l<0||e.direction.right===!0&&p>m&&l>0?(e.event.detected=!0,e.move(a)):e.end(a,!0))},end(a,i){if(e.event!==void 0){if(k(e,"temp"),T.is.firefox===!0&&A(t,!1),i===!0)e.styleCleanup!==void 0&&e.styleCleanup(),e.event.detected!==!0&&e.initialEvent!==void 0&&e.initialEvent.target.dispatchEvent(e.initialEvent.event);else if(e.event.detected===!0){e.event.isFirst===!0&&e.handler(P(a===void 0?e.lastEvt:a,e).payload);const{payload:l}=P(a===void 0?e.lastEvt:a,e,!0),o=()=>{e.handler(l)};e.styleCleanup!==void 0?e.styleCleanup(o):o()}e.event=void 0,e.initialEvent=void 0,e.lastEvt=void 0}}};if(t.__qtouchpan=e,s.mouse===!0){const a=s.mouseCapture===!0||s.mousecapture===!0?"Capture":"";D(e,"main",[[t,"mousedown","mouseStart",`passive${a}`]])}T.has.touch===!0&&D(e,"main",[[t,"touchstart","touchStart",`passive${s.capture===!0?"Capture":""}`],[t,"touchmove","noop","notPassiveCapture"]])},updated(t,n){const s=t.__qtouchpan;s!==void 0&&(n.oldValue!==n.value&&(typeof value!="function"&&s.end(),s.handler=n.value),s.direction=_(n.modifiers))},beforeUnmount(t){const n=t.__qtouchpan;n!==void 0&&(n.event!==void 0&&n.end(),k(n,"main"),k(n,"temp"),T.is.firefox===!0&&A(t,!1),n.styleCleanup!==void 0&&n.styleCleanup(),delete t.__qtouchpan)}}),me=I({name:"QSplitter",props:{...G,modelValue:{type:Number,required:!0},reverse:Boolean,unit:{type:String,default:"%",validator:t=>["%","px"].includes(t)},limits:{type:Array,validator:t=>t.length!==2||typeof t[0]!="number"||typeof t[1]!="number"?!1:t[0]>=0&&t[0]<=t[1]},emitImmediately:Boolean,horizontal:Boolean,disable:Boolean,beforeClass:[Array,String,Object],afterClass:[Array,String,Object],separatorClass:[Array,String,Object],separatorStyle:[Array,String,Object]},emits:["update:modelValue"],setup(t,{slots:n,emit:s}){const{proxy:{$q:d}}=B(),e=W(t,d),a=M(null),i={before:M(null),after:M(null)},l=g(()=>`q-splitter no-wrap ${t.horizontal===!0?"q-splitter--horizontal column":"q-splitter--vertical row"} q-splitter--${t.disable===!0?"disabled":"workable"}`+(e.value===!0?" q-splitter--dark":"")),o=g(()=>t.horizontal===!0?"height":"width"),r=g(()=>t.reverse!==!0?"before":"after"),u=g(()=>t.limits!==void 0?t.limits:t.unit==="%"?[10,90]:[50,1/0]);function p(c){return(t.unit==="%"?c:Math.round(c))+t.unit}const m=g(()=>({[r.value]:{[o.value]:p(t.modelValue)}}));let h,f,b,q,v;function F(c){if(c.isFirst===!0){const C=a.value.getBoundingClientRect()[o.value];h=t.horizontal===!0?"up":"left",f=t.unit==="%"?100:C,b=Math.min(f,u.value[1],Math.max(u.value[0],t.modelValue)),q=(t.reverse!==!0?1:-1)*(t.horizontal===!0?1:d.lang.rtl===!0?-1:1)*(t.unit==="%"?C===0?0:100/C:1),a.value.classList.add("q-splitter--active");return}if(c.isFinal===!0){v!==t.modelValue&&s("update:modelValue",v),a.value.classList.remove("q-splitter--active");return}const y=b+q*(c.direction===h?-1:1)*c.distance[t.horizontal===!0?"y":"x"];v=Math.min(f,u.value[1],Math.max(u.value[0],y)),i[r.value].value.style[o.value]=p(v),t.emitImmediately===!0&&t.modelValue!==v&&s("update:modelValue",v)}const j=g(()=>[[se,F,void 0,{[t.horizontal===!0?"vertical":"horizontal"]:!0,prevent:!0,stop:!0,mouse:!0,mouseAllDir:!0}]]);function U(c,y){c<y[0]?s("update:modelValue",y[0]):c>y[1]&&s("update:modelValue",y[1])}return E(()=>t.modelValue,c=>{U(c,u.value)}),E(()=>t.limits,()=>{K(()=>{U(t.modelValue,u.value)})}),()=>{const c=[w("div",{ref:i.before,class:["q-splitter__panel q-splitter__before"+(t.reverse===!0?" col":""),t.beforeClass],style:m.value.before},S(n.before)),w("div",{class:["q-splitter__separator",t.separatorClass],style:t.separatorStyle,"aria-disabled":t.disable===!0?"true":void 0},[L("div",{class:"q-splitter__separator-area absolute-full"},S(n.separator),"sep",t.disable!==!0,()=>j.value)]),w("div",{ref:i.after,class:["q-splitter__panel q-splitter__after"+(t.reverse===!0?"":" col"),t.afterClass],style:m.value.after},S(n.after))];return w("div",{class:l.value,ref:a},$(n.default,c))}}}),fe=`# Conceptual Architecture - Services and Design
...
`,ge=`# Data Stewardship and Governance
...
`,ye=`# Development Roadmap and Timeline
...
_TDIS Roadmap_
`,be=`# TDIS Steering Committee Roster (as of May 2022)
